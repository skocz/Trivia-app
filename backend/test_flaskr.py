...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # "postgres://{}/{}".format('joannas@localhost:5432', self.database_name)
    ...
    def test_get_categories_not_found(self):
        # Test for error when no categories are found
        res = self.client().get('/categories?page=10000')
        data = json.loads(res.data)

        self.assertEqual(res.status_code, 404)
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], 'Categories not found')
